...
public class Mechanicregister extends AppCompatActivity implements JsonResponse {
...
//                district=e10.getText().toString();
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response = (JsonResponse) Mechanicregister.this;
                    String q ="/driver?fname="+fname+"&lname="+lname+"&place="+place+"&phone="+phone+"&email="+email+"&username="+user+"&password="+password+"&address="+address+"&lati="+LocationService.lati +"&longi="+LocationService.logi;
                    q = q.replace(" ","%20");
                    JR.execute(q);
                }
            }
