...
public class login extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    com.example.blablacar.JsonReq JR=new com.example.blablacar.JsonReq();
        ...
        try {
            ...
            if (status.equalsIgnoreCase("success")) {
                ...
                if(usertype.equals("user"))
                {
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.blablacar.Userhome.class));
                }
    ...
    public void onBackPressed()
    {
        ...
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(), com.example.blablacar.Ipsettings.class);
        startActivity(b);
    }
    }