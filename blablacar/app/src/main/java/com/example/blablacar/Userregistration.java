...
//                district=e10.getText().toString();
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    String q ="/userregister?fname="+fname+"&lname="+lname+"&place="+place+"&phone="+phone+"&email="+email+"&username="+user+"&password="+password+"&address="+address+"&lati="+LocationService.lati +"&longi="+LocationService.logi;
                    q = q.replace(" ","%20");
                    JR.execute(q);
                }
            }
