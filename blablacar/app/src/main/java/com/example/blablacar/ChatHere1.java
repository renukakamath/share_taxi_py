...
public class ChatHere1 extends Activity  implements JsonResponse
{
	EditText ed1;
	ImageView b1;
	String chat;
...
//		url = sh.getString("url", "");
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				else
				{
			        ...
			        JR.json_response=(JsonResponse) ChatHere1.this;
			        String q = "/chat1?sender_id="+sh.getString("log_id", "")+"&details="+chat+"&receiver_id="+Userviewrequest.lid;
			        q=q.replace(" ","%20");
			        JR.execute(q);
	...
	void getChats() {
			...
			JsonReq JR=new JsonReq();
	        JR.json_response=(JsonResponse) ChatHere1.this;
	        String q = "/chatdetail1?sender_id="+sh.getString("log_id", "")+"&receiver_id="+Userviewrequest.lid;
	        q=q.replace(" ","%20");
