	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				String q="/AndroidBarcodeQrExample4?contents="+contents+"&latitude="+tolatti +"&longitude="+tolongi+ "&logid=" + sh.getString("log_id", "")+"&rid="+Userrequest.rid +"&amts="+Userrequest.amt+"&qty="+Userrequest.qty+"&cic="+Userrequest.cid;
				q=q.replace(" ","%20");
				JR.execute(q);
